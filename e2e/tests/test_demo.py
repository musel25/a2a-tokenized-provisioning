"""M6.2/M6.3 — the two e2e runs, as one test: bandwidth plateau + telemetry export config,
...
def test_bandwidth_and_telemetry_e2e():
    ...
    # M6.3: the telemetry ticket configured a real export destination on the device
    assert measured["telemetry_export"] and measured["telemetry_export"].startswith("a2a-"), measured
